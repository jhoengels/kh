...
class pos_report_bolet_venta(report_sxw.rml_parse):

    def __init__(self, cr, uid, name, context):
        super(pos_report_bolet_venta, self).__init__(cr, uid, name, context=context)
    ...
    def _ticket_factura_pago_tarjeta(self, session_id):
        ...
        data=[]
        res = {}
        pos_order_id = pos_order_obj.search(self.cr,self.uid,['|',('state','=','done'),('state','=','paid'),('pos_reference','ilike','TB 00%'),('session_id','=',session_id)])
...
report_sxw.report_sxw('report.pos.session.venta.boleta.print', 'pos.session', 'addons/pos_extend/report/pos_report_bolet_venta.rml', parser=pos_report_bolet_venta, header=False)
